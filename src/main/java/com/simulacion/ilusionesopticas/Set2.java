    ...
    private void initComponents() {
        ...
        jPanel4 = new javax.swing.JPanel() {
            protected void paintComponent(Graphics g ) {
                ...
                for (int i = 0; i <= W / 2; i += 10){
                    ...
                    g.drawLine(W/2,H/2+i,W/2+i,H);
                    g.drawLine(W/2+i,H/2,W,H/2+i);
                    g.drawLine(0,H/2+i,W/2-i,H/2);
                    g.drawLine(i,H,W/2,H-i);
                    g.drawLine(W/2,i,W-i,0);
                    g.drawLine(W/2+i,H/2,W-1,H/2-i);
                }
            }
        };
        jPanel5 = new javax.swing.JPanel() {
            protected void paintComponent(Graphics g) {
                ...
                for (int i = 0; i <= H / 4; i += 10) {
                    int rojo = (int) (Math.random() * 256);
                    int verde = (int) (Math.random() * 256);
                    int azul = (int) (Math.random() * 256);
                    g.setColor(new Color(rojo, verde, azul));
                    g.drawLine(W / 2, H - i, ((3 * W) / 4) - i, H);
                    g.drawLine(W / 2, H - i, ((1 * W) / 4) + i, H);
                    //g.drawLine(W / 2, H - i, i, H);
                }
            }
        };
